...
const en = {
  ...
  mealGuide: {
    ...
    categories: [
      {
        name: "Drinks",
        green: ["Cold water, still", "Milk", "Squash, still", "A mild smoothie in a small glass"],
        yellow: ["Soda: about 3 a day"],
        red: ["Energy drinks and coffee", "Large amounts of soda", "Soda right before bed", "Alcohol"],
      },
      {
        name: "Breakfast",
        green: ["Oatmeal", "Yogurt/skyr with oats", "Toast with egg or a mild topping"],
        yellow: ["Fatty cheese"],
        red: ["Very sweet cereals", "Pastries", "Very fatty breakfasts"],
      },
      {
        name: "Carbohydrates",
        green: ["Rice, pasta and potatoes", "Oats", "Toast and soft bread"],
        yellow: ["Rye bread and crispbread"],
        red: ["French fries", "Chips", "Very fatty pizza"],
      },
      {
        name: "Protein",
        green: ["Eggs", "Chicken or turkey", "Fish", "Skyr or yogurt"],
        yellow: ["Tuna and strong-smelling food"],
        red: ["Very fatty meat", "Bacon", "Deep-fried meat"],
      },
      {
        name: "Fruit & vegetables",
        green: ["Banana, melon and pear", "Cucumber", "Cooked carrots", "Other mild vegetables"],
        yellow: ["Apple, berries and avocado"],
        red: ["Raw vegetables", "Citrus and sour berries", "Tomato and tomato sauce"],
      },
      {
        name: "Sweets & snacks",
        green: ["Banana", "Yogurt", "A mild smoothie", "Toast", "Crackers and rice cakes"],
        yellow: ["Cake or candy after a meal"],
...
const da: typeof en = {
  ...
  mealGuide: {
    ...
    yellow: "Gul",
    red: "Rød",
    greenHint: "Gode standardvalg",
    yellowHint: "Begræns eller test",
    redHint: "Pause i 2-3 dage, fordi det ofte har udløst symptomer",
    categories: [
      {
        name: "Drikke",
        green: ["Koldt vand uden brus", "Mælk", "Saftevand uden brus", "Mild smoothie i et lille glas"],
        yellow: ["Sodavand: ca. 3 om dagen"],
        red: ["Energidrik og kaffe", "Store mængder sodavand", "Sodavand lige før sengetid", "Alkohol"],
      },
      {
        name: "Morgenmad",
        green: ["Havregrød", "Yoghurt/skyr m. havregryn", "Toast med æg/mildt pålæg"],
        yellow: ["Fed ost"],
        red: ["Meget søde morgenmadsprodukter", "Wienerbrød", "Meget fed morgenmad"],
      },
      {
        name: "Kulhydrat",
        green: ["Ris, pasta og kartofler", "Havregryn", "Toast og blødt brød"],
        yellow: ["Rugbrød og knækbrød"],
        red: ["Pommes frites", "Chips", "Meget fed pizza"],
      },
      {
        name: "Protein",
        green: ["Æg", "Kylling eller kalkun", "Fisk", "Skyr eller yoghurt"],
        yellow: ["Tun og kraftigt lugtende mad"],
        red: ["Meget fedt kød", "Bacon", "Friturestegt kød"],
      },
      {
        name: "Frugt og grønt",
        green: ["Banan, melon og pære", "Agurk", "Kogte gulerødder", "Andre milde grøntsager"],
        yellow: ["Æble, bær og avocado"],
        red: ["Rå grøntsager", "Citrus og sure bær", "Tomat og tomatsauce"],
      },
      {
        name: "Sødt og snacks",
        green: ["Banan", "Yoghurt", "Mild smoothie", "Toast", "Kiks og riskiks"],
        yellow: ["Kage eller slik efter mad"],
        red: ["Store slikportioner", "Surt slik", "Chokolade på tom mave"],
      },
      {
        name: "Smag",
        green: ["Milde krydderier", "Lidt salt"],
