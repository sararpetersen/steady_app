...
const en = {
  ...
  settings: {
    ...
    dateReminders: { label: "Remind me about upcoming dates", description: "A gentle nudge on Home when a date is coming up in the next few days – never a push notification." },
  ...
  dates: {
    ...
    noDatesThisDay: "Nothing on this day.",
    upcoming: {
...
const da: typeof en = {
  ...
  settings: {
    ...
    dateReminders: { label: "Mind mig om kommende datoer", description: "Et blidt praj på Hjem, når en dato nærmer sig i de kommende dage – aldrig en push-notifikation." },
  ...
  dates: {
    ...
    day: "dag",
    days: "dage",
    viewToggleLabel: "Visning",
    viewList: "Liste",
    viewCalendar: "Kalender",
    prevMonth: "Forrige måned",
    nextMonth: "Næste måned",
    noDatesThisDay: "Ingenting denne dag.",
    upcoming: {
