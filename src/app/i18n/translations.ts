...
const en = {
  ...
  sensoryTips: {
    ...
    "Temperature-sensitive": "Keep a layer nearby so you can adjust to the room's temperature.",
  ...
  focus: {
    ...
    companion: {
      ...
      wrappingUp: "About a minute left — start wrapping up whenever feels right.",
...
const da: typeof en = {
  ...
  sensoryTips: {
    ...
    "Temperature-sensitive": "Hav et lag tøj i nærheden, så du kan justere til temperaturen i rummet.",
  ...
  focus: {
    ...
    companion: {
      ...
      wrappingUp: "Cirka et minut tilbage – begynd at runde af, når det føles rigtigt.",
