...
const en = {
  ...
  routines: {
    ...
    hardDayLabel: "Hard day mode",
    hardDayDescription: "Show the lighter alternatives you've set for today's steps.",
    hardDayTextLabel: "Lighter alternative for a hard day (optional)",
    hardDayBadge: "Hard day",
...
const da: typeof en = {
  ...
  routines: {
    ...
    hardDayLabel: "Svær-dag-tilstand",
    hardDayDescription: "Vis de lettere alternativer, du har sat for dagens trin.",
    hardDayTextLabel: "Lettere alternativ til en svær dag (valgfrit)",
    hardDayBadge: "Svær dag",
